    ...
    li.innerHTML = `
        <div class="action-container">
            ...
            <div class="todo-actions">
                ...
                <input type="checkbox" id="check" name="todo-completed-${todoObj.id}" class="completed"  />
...
document.todoForm.addEventListener("submit", function (e) {
    ...
    //? POST to server
    axios.post('https://api.vschool.io/jameelmatin/todo', {
        title: title,
...
var deleteTodo = function (singleTodoObject) {
    ...
    axios.delete("https://api.vschool.io/jameelmatin/todo" + singleTodoObject._id).then(function (response) {
